...
namespace CustomControls
{
     ...
     */
    class Frame : public ImageControl
    {
    public:
        Frame();
     ...
     */
    class RoundedFrame : public Frame
    {
    public:
        RoundedFrame();
     ...
     */
    class ControlNode : public osg::Node
    {
    public:
     ...
     */
    class ControlNodeBin : public osg::Group
    {
    public:
        ControlNodeBin();
     ...
     */
    class ControlCanvas : public osg::Camera
    {
    public:
